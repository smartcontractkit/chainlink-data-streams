...
func (ds testDataSource) Observe(ctx context.Context, repts types.ReportTimestamp, fetchMaxFinalizedTimestamp bool) (v2.Observation, error) {
	return ds.Obs, nil
}
...
type testReportCodec struct {
	...
	builtReportFields *v2.ReportFields
	err               error
}

func (rc *testReportCodec) BuildReport(ctx context.Context, rf v2.ReportFields) (types.Report, error) {
...
func Test_Plugin_Report(t *testing.T) {
	...
	t.Run("when previous report is nil", func(t *testing.T) {
		...
		t.Run("succeeds and generates validFromTimestamp from maxFinalizedTimestamp when maxFinalizedTimestamp is positive", func(t *testing.T) {
			...
			assert.Equal(t, v2.ReportFields{
