...
func buildPayload(encoders []ABIEncoder, values []protocol.StreamValue) (payload []byte, merr error) {
...
func (r ReportCodecEVMABIEncodeUnpacked) buildHeader(rf BaseReportFields, resolution protocol.TimeResolution) ([]byte, error) {
	var merr error
	if rf.LinkFee == nil {
