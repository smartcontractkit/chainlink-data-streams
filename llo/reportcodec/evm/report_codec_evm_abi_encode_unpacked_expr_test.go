...
func TestReportCodecEVMABIEncodeUnpackedExpr_Encode(t *testing.T) {
	...
	t.Run("varying timestamp resolution schemas", func(t *testing.T) {
		runTest := func(sampleFeedID common.Hash, sampleObservationTimestampNanoseconds, sampleValidAfterNanoseconds uint64, sampleExpirationWindow uint32, priceMultiplier, marketDepthMultiplier *ubig.Big, sampleBaseUSDFee, sampleLinkBenchmarkPrice, sampleNativeBenchmarkPrice, sampleDexBasedAssetPrice, sampleBaseMarketDepth, sampleQuoteMarketDepth decimal.Decimal, sampleTimeResolution protocol.TimeResolution) bool {
